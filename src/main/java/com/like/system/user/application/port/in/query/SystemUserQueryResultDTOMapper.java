...
public class SystemUserQueryResultDTOMapper {

	public static SystemUserQueryResultDTO toDTO(SystemUser entity, String companyCode) {					
		...
		SystemUserQueryResultDTO dto = SystemUserQueryResultDTO.builder()																		   
